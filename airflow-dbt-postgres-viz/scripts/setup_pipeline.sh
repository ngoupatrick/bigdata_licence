...
# airflow : Postgres
echo "⏳ Suppression airflow destination ..."
psql -h postgres -U postgres_user -d postgres_db < /sql/delete_db_airflow.sql
...
# airflow : Postgres
echo "⏳ creation bd [airflow] Airflow ..."
psql -h postgres -U postgres_user -d postgres_db < /sql/create_db_airflow.sql
